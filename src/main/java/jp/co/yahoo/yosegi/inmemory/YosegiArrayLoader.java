...
public class YosegiArrayLoader implements IArrayLoader<IColumn> {
   ...
   */
  public YosegiArrayLoader( final ColumnBinary columnBinary , final int loadSize ) {
  ...
  public void setArrayIndex(
    ...
    arrayCells[index] = new ArrayCell(
        new SpreadArrayLink( spread , index , start , start + length ) );
  }
